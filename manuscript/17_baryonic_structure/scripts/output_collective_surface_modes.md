...
|---|---:|---:|---:|
| scalar surface | `0.25`–`2.0` | `3.320331e-03` | `12.680%` |
| scalar surface | `0.25`–`4.0` | `1.386907e-02` | `33.010%` |
| scalar surface | `0.50`–`4.0` | `1.435436e-02` | `33.015%` |
| collective modes | `0.25`–`2.0` | `1.437846e-03` | `5.491%` |
| collective modes | `0.25`–`4.0` | `1.755457e-03` | `4.178%` |
| collective modes | `0.50`–`4.0` | `1.815911e-03` | `4.177%` |

## Sample

| $q$ fm$^{-1}$ | GDQ refined | Galster | $\mathcal I_\Sigma$ |
|---:|---:|---:|---:|
...
The collective modes preserve zero charge and low-energy slope. The comparison with Galster is a shape benchmark: it informs the size of the probe's response, but does not alter the official action.
