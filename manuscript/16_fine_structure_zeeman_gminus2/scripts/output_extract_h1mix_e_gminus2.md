...
- input: `manuscript/16_fine_structure_zeeman_gminus2/scripts/leptonic_h1mix_background_e_gminus2.npz`
- classification: reduced H1 mixture of the electron; allowed, not final metrology
- dimension: `3`
