...
- input: `manuscript/16_fine_structure_zeeman_gminus2/scripts/leptonic_stable_background_e_gminus2.npz`
- classification: minimal effective background of the electron; leading term only
- dimension: `3`
