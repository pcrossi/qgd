...
- input: `manuscript/16_fine_structure_zeeman_gminus2/scripts/leptonic_selection_background_mu_gminus2.npz`
- classification: Hodge selection of the muon; universal direct upper source null
- dimension: `3`
