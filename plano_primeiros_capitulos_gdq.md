...
Fontes: atual Capítulo 2, `questão_2.md`, `questão_3.md` e consolidação da
Questão 4.
...
Fontes: atual Capítulo 4, `questão_2.md`, `questão_4.md`, `questão_10.md` e
`questão_11.md`.
...
Fontes: atuais Capítulos 9, 10, 11 e 19; `questão_42.md`,
`teorema_noether_zeeman_gdq.md` e `projecao_hessiana_noether_g2.md`.
...
possibilidades.md           ideias futuras
