...
\[
\texttt{q28/fibrado\_interno\_efetivo.md}
\]

e:

\[
\texttt{q28/espectro\_hipercarga\_anomalias.md}.
\]
...
\[
\texttt{q28/indice\_tres\_geracoes.md}.
\]
...
\[
\texttt{q28/classes\_caracteristicas\_hipercarga.md}.
\]
...
\[
\texttt{q28/quiralidade\_aps\_bismut.md}.
\]
...
\[
\texttt{q28/eta\_borda\_estomatos.md}.
\]
...
$$
\texttt{q28/prototipo\_u1\_estomato.md}
$$

e

$$
\texttt{q28/test\_prototipo\_u1.py}.
$$
...
$$
\texttt{q28/eta\_s3\_hopf\_bismut.md}
$$

e

$$
\texttt{q28/test\_eta\_s3\_hopf.py}.
$$
...
$$
\texttt{q28/preenchimento\_aps\_u1.md}
$$

e

$$
\texttt{q28/test\_fluxo\_espectral\_u1.py}.
$$
...
$$
\texttt{q28/elevacao\_indice\_representacoes.md}
$$

e

$$
\texttt{q28/test\_elevacao\_representacoes.py}.
$$
...
$$
\texttt{q28/quociente\_z6\_hipercargas.md}
$$

e

$$
\texttt{q28/test\_hipercargas\_z6.py}.
$$
...
$$
\texttt{q28/classes\_naoabelianas\_prototipo.md}
$$

e

$$
\texttt{q28/test\_classes\_naoabelianas.py}.
$$
...
$$
\texttt{q28/auditoria\_tres\_geracoes.md}
$$

e

$$
\texttt{q28/test\_betti\_t5\_s3.py}.
$$
...
$$
\texttt{q28/aplicacao\_perelman\_tres\_geracoes.md}.
$$
...
$$
\texttt{q28/indice\_global\_t5\_s3.md}
$$

e

$$
\texttt{q28/test\_indice\_global\_t5\_s3.py}.
$$
...
`q28/berry_kernel_t5.md` e `q28/test_berry_kernel_t5.py`.
...
O desenvolvimento e o teste estão em `q28/colagem_projetiva_z6.md` e
`q28/test_colagem_projetiva_z6.py`.
...
Esse resultado está documentado em `q28/pullback_hessiana_global.md` e
`q28/test_pullback_hessiana_global.py`.
...
A derivação está em `q28/fibracao_su2_acao_oficial.md`; o teste dos setores
está em `q28/test_setores_acao_oficial.py`.
...
Os detalhes estão em `q28/acao_onshell_setores.md` e
`q28/test_acao_onshell_setores.py`.
...
O cálculo e sua verificação estão em `q28/retroacao_modulo_radial.md` e
`q28/test_retroacao_modulo_radial.py`.
...
O cálculo está em `q28/retroacao_anisotropica_t5.md` e
`q28/test_retroacao_anisotropica_t5.py`.
...
O resultado está em `q28/retroacao_dilatao_cern.md` e
`q28/test_retroacao_dilatao_cern.py`.
...
`q28/formulacao_global_tensao.md`.
...
`q28/tensao_global_cosmologica.md` e
`q28/test_isotropia_global.py`.
...
O cálculo está em `q28/selecao_aritmetica_carga_global.md` e é verificado por
`q28/test_selecao_aritmetica.py`.
...
A auditoria completa está em `q28/auditoria_localizacao_k3.md`, com teste em
`q28/test_localizacao_k3.py`.
...
A análise completa está em `q28/auditoria_rotas_cobordismo_w9.md`, com o teste
de pontos fixos em `q28/test_pontos_fixos_z3.py`.
...
A derivação completa está em `q28/cirurgia_tres_estomatos.md`, com teste em
`q28/test_cirurgia_tres_estomatos.py`.
...
`q28/selecao_torcional_tres_estomatos.md`, com teste em
`q28/test_selecao_torcional_tres.py`.
...
`q28/estabilidade_completa_junction_torcional.md`, com verificação algébrica
em `q28/test_criterio_schur_junction.py`.
...
`q28/fechamento_selecao_tres_estomatos.md`.
...
`q28/hessiana_background_tres_centros.md`.
...
`q28/hessiana_vinculada_tres_centros_final.md` e
`q28/test_hessiana_vinculada_tres_centros.py`.
...
o teste estão em `q28/hessiana_espectral_completa_background_c3.md` e
`q28/espectro_completo_hessiana_tres_centros.py`.
...
`q28/acoplamentos_geometricos_finais.md` e
`q28/calcular_acoplamentos_q28.py`.
