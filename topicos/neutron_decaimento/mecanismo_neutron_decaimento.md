...
O refinamento bimodal está em `topicos/geometria_torcao_hopf/nucleacao_par_mesonico_torcional.md`. A rota
agora testada é
...
topicos/geometria_torcao_hopf/nucleacao_par_mesonico_torcional.md.
...
`topicos/geometria_torcao_hopf/hessiana_estratificada_nucleacao_bimodal.md`. Isso decidirá se há nucleação
...
`topicos/neutron_decaimento/fechamento_condicional_mecanismo_neutron.md`. A vida média numérica permanece
