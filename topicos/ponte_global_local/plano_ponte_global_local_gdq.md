...
O arquivo `topicos/ponte_global_local/ponte_global_local_lema1.md` construiu explicitamente a família
homogênea
...
Em `topicos/ponte_global_local/ponte_global_local_lema1.md` foi fixado um colar de Berger com funções
...
O arquivo `topicos/ponte_global_local/ponte_global_local_lema2.md` construiu as imersões apontadas e
demonstrou
...
`topicos/ponte_global_local/ponte_global_local_hipotese_BI.md` como hipótese técnica futura, com nove
condições auditáveis. Sob essa hipótese, `topicos/ponte_global_local/ponte_global_local_lema3.md`
...
`topicos/ponte_global_local/ponte_global_local_lema4.md` demonstrou um critério suficiente de gap e a
...
`topicos/ponte_global_local/ponte_global_local_lema5.md` combinou a convergência de formas do Lema 3 com
...
`topicos/ponte_global_local/ponte_global_local_lema6.md` separou os quatro mecanismos da ponte:
