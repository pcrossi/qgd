...
> foi posteriormente construído em `topicos/ponte_global_local/ponte_global_local_exterior_causal.md`.
> O estado numérico vigente está em
> `topicos/ponte_global_local/ponte_global_local_solver_final_resultado.md`.
