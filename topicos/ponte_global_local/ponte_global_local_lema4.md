...
> global--local. Ver `topicos/ponte_global_local/ponte_global_local_lemas_sem_colar.md`.
...
O documento `questoes/q29/associados/fase1_colar_dinamico_reducao_radial.md` já derivou
