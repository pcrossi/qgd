...
`topicos/ponte_global_local/ponte_global_local_exterior_warped.md`, incluindo o multiplicador $\lambda_N$
da normalização:
...
Berger e é formulada em `topicos/ponte_global_local/ponte_global_local_exterior_berger.md`.
