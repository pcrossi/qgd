...
> `topicos/ponte_global_local/ponte_global_local_exterior_causal.md` mantém $s$ como coordenada radial e
...
Foi calculada em `topicos/ponte_global_local/ponte_global_local_potencial_simpletico.md` a decomposição
explícita
