...
> `topicos/ponte_global_local/ponte_global_local_lemas_sem_colar.md`, não uma sela de colagem.
...
O subsector isotrópico está em `topicos/ponte_global_local/ponte_global_local_exterior_warped.md` e foi
usado apenas para validar a álgebra. A redução física compatível com o DtN
interno é o exterior de dois raios em
`topicos/ponte_global_local/ponte_global_local_exterior_berger.md`. Ele mantém o modo anisotrópico que
deve ser testado pela Hessiana.
O adaptador canônico e o resíduo conjunto de duas interfaces estão definidos
em `topicos/ponte_global_local/ponte_global_local_colagem.md`.
...
`topicos/ponte_global_local/ponte_global_local_vinculo_cosmologico.md` como o conjunto formado pelo
