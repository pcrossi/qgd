...
`topicos/geometria_torcao_hopf/hessiana_estratificada_nucleacao_bimodal.md`: usa-se a diferença unilateral
...
`topicos/geometria_torcao_hopf/nucleo_critico_par_mesonico.md` mostra que o potencial toma a forma
