...
O potencial abaixo é efetivo: ele é a restrição da ação oficial da GDQ a uma
direção espectral da Hessiana. Não é um potencial de Higgs postulado como termo
...
Atualização posterior: no fechamento estrutural reduzido da Q29 foram
obtidos \(a_2=-0{,}253196676<0\) e
\(a_4^{\rm total}=2133{,}554507>0\). A pendência remanescente é global:
transportar a normalização dimensional/causal e as normas eletrofracas, não
postular um potencial adicional.
