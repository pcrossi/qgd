#!/usr/bin/env python3
"""
Q43 — construtor operacional de blocos H_C, c, m_perp.
...
def main() -> None:
    ...
    lines: list[str] = []
    lines.append("# Q43 — saída do construtor de blocos de Hessiana")
    lines.append("")
    ...
    lead_path = base / "hessiana_lider_q43.npz"
    ...
    for case in cases:
        ...
        out = base / f"hessiana_required_{case.symbol}_q43.npz"
        save_npz(out, H, c, m)
        ev = evaluate(H, c, m)
        lines.append(
    ...
    report = base / "saida_blocos_hessiana_q43.md"
