#!/usr/bin/env python3
"""Q43 — derivação do canal superior físico de fonte magnética.
...
def main() -> None:
    ...
    for symbol, (role, ratio) in lepton_map.items():
        ...
        out = BASE / f"background_leptonico_selecao_{symbol}_q43.npz"
        np.savez(
            out,
            H=H,
            c=c,
    ...
    report = BASE / "saida_canal_superior_fisico_q43.md"
