#!/usr/bin/env python3
"""Q43 — Hessiana oficial reduzida por Galerkin.
...
def main() -> None:
    ...
    np.savez(base / "hessiana_oficial_galerkin_nua_q43.npz", H=H, c=c, m_perp=m_perp_official_naked, gamma0=np.array([1.0]))
    np.savez(base / "hessiana_oficial_galerkin_lider_q43.npz", H=H, c=c, m_perp=m_perp_leader, gamma0=np.array([1.0]))
    ...
    report = base / "saida_hessiana_oficial_galerkin_q43.md"
