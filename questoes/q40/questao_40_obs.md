...
5. `questoes/q30/questao_30.md`, para confinamento;
6. `questoes/q36/questao_36.md`, para calibração metrológica de massas;
7. `questoes/q38/historico/questao_38.md`, para evitar circularidade quando $M_p$ entra em $G$.
...
$$
\texttt{questoes/q40/associados/adendo\_volume\_superficie.md}.
$$
...
$$
\texttt{questoes/q40/associados/adendo\_bulk\_6pi5.md}.
$$
...
$$
\texttt{questoes/q40/associados/adendo\_reducao\_variacional\_bulk.md}.
$$
...
$$
\texttt{questoes/q40/associados/adendo\_ansatz\_gp\_fp.md}.
$$
...
$$
\texttt{questoes/q40/associados/adendo\_cola\_torcao\_superficie.md}.
$$
...
Após os adendos da pasta `questoes/q40/associados/`, essa fórmula deixa de ser apenas uma proposta
...
$$
\texttt{questoes/q40/associados/adendo\_neutron\_deltaB.md}.
$$
