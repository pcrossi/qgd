...
## 0. Nota de estado vigente GDQ

Este documento preserva a auditoria histórica, incluindo a comparação com a
linguagem de Yang--Mills. O estado vigente da GDQ é mais específico:

$$
\boxed{
\text{Q30 fechada estruturalmente na GDQ e metrologicamente condicionada
ao raio efetivo de superfície/sonda; não como solução Clay/YM puro.}
}
$$

A rota física atual não toma Yang--Mills como ação fundamental. Ela usa o
pescoço transversal Ricci--Bohm do sóliton GDQ:
...
A integração direta reduzida documentada em
`associados/saida_integracao_direta_tubo_ricci_bohm_q30.md` usa a escala
legada $r_\perp=0{,}86\,\mathrm{fm}$ e integra a densidade transversal no
disco:
...
O coeficiente também foi derivado diretamente no cap Ricci--Bohm primitivo em
`associados/derivacao_C_GDQ_tubo_ricci_bohm_q30.md`:
...
$$
\Delta_{\rm GDQ}=0{,}22945\,\mathrm{GeV},
\qquad
\sigma_{\rm GDQ}=0{,}83818\,\mathrm{GeV/fm}
=0{,}16540\,\mathrm{GeV}^2.
$$

Esse resultado fecha apenas o cap primitivo reduzido. Ele não bate sozinho
metrologicamente com a escala hadrônica usual
$\sigma_{\rm had}\simeq0{,}89\,\mathrm{GeV/fm}$: o desvio é
$-5{,}822006\%$.

A derivação canônica de raio disponível no corpus vem da cadeia Q39/Q40:
...
Com $\epsilon_{\rm eff}=0{,}011591040463$ e
...
\qquad
\sigma_{\rm GDQ}=0{,}876946044304\,\mathrm{GeV/fm},
$$

com desvio $-1{,}466737\%$.

O raio legado comprimido $0{,}8354\,\mathrm{fm}$, registrado em
`pt-br/notas/27/nota_27.4_raio_do_proton.md`, gera
$F_{\rm shape}=1{,}059761067152$ e
$\sigma_{\rm GDQ}^{\rm eff}=0{,}888274921594\,\mathrm{GeV/fm}$, com desvio
$-0{,}193829\%$. Porém, esse segundo valor deve ser classificado como cenário
de compressão de sonda/probe até ser rederivado no mesmo background
transversal da ação oficial.

Assim, a conclusão vigente é:

$$
\boxed{
\text{lei linear, gap positivo e escala de tensão fechados na GDQ;}
}
$$

$$
\boxed{
\text{metrologia fina condicionada à escolha física do contorno de sonda.}
}
$$
