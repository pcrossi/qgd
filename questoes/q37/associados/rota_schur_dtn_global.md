...
Foram auditados `questoes/q29/associados/problema_sturm_liouville_wz.md` e
`questoes/q29/associados/solve_sturm_liouville_wz_q29.py`. Esse operador tem variável
