...
> A prova vigente está em `ponte_global_local_lemas_sem_colar.md`. O colar
...
`q30/reducao_torcao_bismut_tubo.md` e em `memory.md`:
...
`ponte_global_local_hipotese_BI.md`. Assim, o Lema 1B é usado adiante apenas
