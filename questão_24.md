...
O resultado único exige uma hipótese ontológica GDQ:
...
Sem essa hipótese, a teoria resolve decoerência e estatística, mas não o
resultado único ontológico.

Com essa hipótese, o “colapso” é:
...
\[
\boxed{
\text{Questão 24 fechada estruturalmente, com a ressalva explícita do
resultado único.}
}
\]
