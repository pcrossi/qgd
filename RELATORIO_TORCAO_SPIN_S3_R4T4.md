...
## 10. Avaliação de `ideiatorcao.md` — decomposição KK proposta

O arquivo `ideiatorcao.md` propõe exatamente o próximo passo indicado em
...
### 10.4 Veredito sobre `ideiatorcao.md`
...
## 11. Avaliação de `ideiatorcao2.md` — execução do módulo \(R(x)\)
...
### 11.4 Veredito sobre `ideiatorcao2.md`
...
## 12. Avaliação de `ideiatorcao3.md` — execução do reescalonamento de Weyl
...
### 12.4 Veredito sobre `ideiatorcao3.md`
...
Inspecionando `questão_39.md` diretamente: as previsões de massa
...
Reexaminando `questão_39.md`: as previsões numéricas citadas
...
`questão_39.md` (acoplamento de Kähler, adimensional) e o
