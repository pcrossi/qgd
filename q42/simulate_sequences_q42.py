#!/usr/bin/env python3
"""Q42 — Sequências de medidas Stern–Gerlach compatíveis e incompatíveis."""
...
from simulate_beam_q42 import sample_channels
...
def main() -> None:
    ...
    report = "\n".join(lines)
    output = Path(__file__).with_name("saida_sequences_q42.md")
