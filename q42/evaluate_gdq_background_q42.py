#!/usr/bin/env python3
"""Avalia coeficientes físicos da Q42 a partir de um background GDQ resolvido.
...
def main() -> None:
    ...
    parser.add_argument(
        "--output",
        type=Path,
        default=Path(__file__).with_name("saida_background_fisico_q42.md"),
    )
    ...
    text = "\n".join(
        [
            "# Avaliação do background físico — Q42",
            "",
