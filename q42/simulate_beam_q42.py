#!/usr/bin/env python3
"""
Q42 — Propagação espacial de um feixe de Stern–Gerlach.
...
from simulate_measurement_q42 import born_probability, logit, sigmoid
...
def simulate_beam(args: argparse.Namespace) -> str:
    ...
    lines = [
        "# Propagação espacial Stern–Gerlach — Q42",
        "",
        "## Parâmetros",
        "",
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        "--output",
        type=Path,
        default=Path(__file__).with_name("saida_beam_q42.md"),
    )
