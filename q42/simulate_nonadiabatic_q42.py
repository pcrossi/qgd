#!/usr/bin/env python3
"""Q42 — varredura não adiabática e limite de validade da prova de Born.
...
def main() -> None:
    ...
    report = "\n".join(lines)
    Path(__file__).with_name("saida_nonadiabatic_q42.md").write_text(
