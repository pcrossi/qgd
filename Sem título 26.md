• Sim — zz2.md contém a intuição certa, mas também mistura três invariâncias diferentes. O ponto realmente promissor é que existe uma família
  ...
  Minha avaliação: encontramos uma rota muito mais concreta do que o “Postulado de Invariância Espectral” de zz2.md. A decomposição
