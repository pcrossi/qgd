Viewed topicos/ponte_global_local/ponte_global_local_exterior_causal.md:1-262
Searched for "limiar"
Viewed topicos/ponte_global_local/ponte_global_local_lema4.md:1-364
...
3. **Energia de Noether:** $\mathcal C_E[X] = \mathcal H_\xi[X] - E_H = 0$ (calculada através da forma potencial simplética $\boldsymbol\Theta_{\rm GDQ}$ associada ao relógio causal, conforme deduzido em [topicos/ponte_global_local/ponte_global_local_vinculo_cosmologico.md](file:///home/pedro/Dropbox/obs/todo/ponte_global_local_vinculo_cosmologico.md)).

---

### Passo 2: Resolução da Unidade de Medida Canônica do Momento ($Z_E$)
Como diagnosticado em [topicos/ponte_global_local/ponte_global_local_solver_final_resultado.md](file:///home/pedro/Dropbox/obs/todo/ponte_global_local_solver_final_resultado.md), o solver numérico causava explosão da integração porque o momento dimensional reduzido $p_0^{\rm red}$ não estava na escala física correta. É obrigatório calcular analiticamente o fator de conversão adimensional $Z_E(\alpha)$:
...
Para receber os traços do DtN interno sem restrições geométricas espúrias, o exterior do estômato não pode ser homogêneo ou radialmente simétrico (antipodal). Conforme formulado em [topicos/ponte_global_local/ponte_global_local_exterior_causal.md](file:///home/pedro/Dropbox/obs/todo/ponte_global_local_exterior_causal.md) e [ponte_global_local_solver_final.py](file:///home/pedro/Dropbox/obs/todo/ponte_global_local_solver_final.py), a colagem deve:
...
Uma vez corrigido o fator de acoplamento de energia $Z_E(\alpha)$, a sela $(X_*, \lambda_*)$ deve ser buscada sobre os 11 parâmetros de disparo do sistema DAE acoplado. Para contornar a rigidez numérica da integração do lapse $\mathcal C_N=0$, deve-se usar o transporte da matriz de sensibilidade variacional ao longo das trajetórias (conforme proposto em [topicos/ponte_global_local/ponte_global_local_fechamento.md](file:///home/pedro/Dropbox/obs/todo/ponte_global_local_fechamento.md)).

---

### Passo 5: Pullback Espectral e Extração de $\mu_*^2$ na Hessiana Física
Com o background elíptico $X_*$ e os multiplicadores $\lambda_*$ congelados, o limiar de massa $\mu_*^2 > 0$ deve ser extraído seguindo rigorosamente os passos do [topicos/ponte_global_local/ponte_global_local_lema4.md](file:///home/pedro/Dropbox/obs/todo/ponte_global_local_lema4.md):
