...
**Arquivo:** `RELATORIO_Q38_3.md`
**Objeto:** Questão 38 (derivação da constante gravitacional de Newton $G$).
**Escopo:** consolida `r38_3.md` (Partes I–V), a auditoria externa, o teste do
saddle do dílaton (`R_38_1t.md`) e o cálculo autoconsistente gap+estabilização.
...
*(Errata: a primeira versão de `r38_3.md` dava $+3\hbar^2/64$ — erro por omitir o
...
### 2.1 A rota do saddle do dílaton (`R_38_1t.md`)
...
versão anterior de `r38_3.md` (sinal do 4-férmions; $N_{\log}=1/8$; alegação de
