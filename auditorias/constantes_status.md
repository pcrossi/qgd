...
O arquivo `questoes/q37/questao_37.md` contém uma rota geométrica para \(\alpha\), incluindo
a fórmula:
...
O adendo `questoes/q31/associados/cp_forte_torcao_su3.md` fixa a arquitetura:
