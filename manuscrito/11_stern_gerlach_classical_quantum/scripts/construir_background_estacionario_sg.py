#!/usr/bin/env python3
"""Constrói e verifica o shrinker gaussiano da Capítulo 11 na fatia C^2."""
...
def main() -> None:
    ...
    parser.add_argument(
        "--report",
        type=Path,
        default=Path(__file__).with_name("saida_background_bulk_sg.md"),
    )
    ...
    text = "\n".join(
        [
            "# Background estacionário de bulk — Capítulo 11",
            "",
            f"- tau: `{args.tau:.12e}`",
            f"- r_c: `{args.r_c:.12e}`",
