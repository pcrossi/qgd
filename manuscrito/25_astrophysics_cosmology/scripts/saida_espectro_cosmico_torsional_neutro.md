...
- massas: `[0.0, 0.008798417219655, 0.05042386973059]` eV;
- $z_{\max}=5.0$.
...
- linha 22 versus 140 um: `+0.473676%`;
- linha 33 versus 24 um: `+2.446020%`;
- redshift da linha 22 para 240 um: `0.706204`.
