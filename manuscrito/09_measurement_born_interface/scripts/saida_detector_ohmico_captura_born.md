# Saída — detector ôhmico e captura Born

Classificação: teste de consistência com parâmetros adimensionais.
...
| p0 | 0.370000000000 |
| trajetorias | 100000.000000000000 |
| tempo final | 4.000000000000 |
...
| teste | valor |
|---|---:|
| erro martingal | 2.457279754300e-03 |
| erro padrão binomial | 1.526761278000e-03 |
| erro martingal em desvios padrão | 1.609472148468 |
| diferença erro MC vs analítico | 4.713057238513e-05 |

## Veredito

O teste confirma o DtN ôhmico, a propriedade de martingal, a captura assintótica condicionada e a relaxação do ponteiro no modelo reduzido. Não calcula parâmetros de material real.
