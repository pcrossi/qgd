...
- entrada: `manuscrito/16_fine_structure_zeeman_gminus2/scripts/background_leptonico_selecao_mu_gmenos2.npz`
- classificação: seleção Hodge do múon; fonte superior direta universal nula
- dimensão: `3`
