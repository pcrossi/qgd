...
- entrada: `manuscrito/16_fine_structure_zeeman_gminus2/scripts/hessiana_oficial_galerkin_nua_gmenos2.npz`
- classificação: Galerkin reduzido da ação oficial sem fonte magnética; teste de consistência
- dimensão: `5`
