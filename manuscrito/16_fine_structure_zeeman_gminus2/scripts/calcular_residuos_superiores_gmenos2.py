#!/usr/bin/env python3
"""Capítulo 16 — resíduos superiores de g-2.
...
def main() -> None:
    ...
    lines = [
        "# Capítulo 16 — resíduos superiores depois do termo líder",
        "",
    ...
    out = Path(__file__).with_name("saida_residuos_superiores_gmenos2.md")
