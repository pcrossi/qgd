...
- entrada: `manuscrito/16_fine_structure_zeeman_gminus2/scripts/background_leptonico_estavel_e_gmenos2.npz`
- classificação: background efetivo mínimo do elétron; termo líder apenas
- dimensão: `3`
