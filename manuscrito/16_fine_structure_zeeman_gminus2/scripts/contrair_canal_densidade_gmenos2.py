#!/usr/bin/env python3
"""Capítulo 16 — contração do canal superior mediado pela densidade.
...
def default_blocks() -> list[Path]:
    return [
        BASE / "background_leptonico_estavel_e_gmenos2.npz",
        BASE / "background_leptonico_estavel_mu_gmenos2.npz",
        BASE / "background_leptonico_estavel_tau_gmenos2.npz",
    ]
...
def main() -> None:
    ...
    out = BASE / "saida_contracao_canal_densidade_gmenos2.md"
