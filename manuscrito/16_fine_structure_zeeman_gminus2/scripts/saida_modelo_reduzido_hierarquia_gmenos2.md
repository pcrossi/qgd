# Saída — Hierarquia leptônica reduzida e resposta magnética
...
- `R_mu = 2.067685934706287e+02`
- `R_tau = 3.477446405098381e+03`

## Hierarquia leptônica usada como background reduzido

| lépton | papel geométrico | R_l=M_l/M_e | chi_rel=1/R_l |
|---|---|---:|---:|
...
A hierarquia leptônica é necessária como background, mas é insuficiente para fechar $g-2$. A hierarquia de massas não pode ser usada como substituto do cálculo Zeeman/anomalia. O próximo elo físico é construir $H_{C,\ell}$, $c_\ell$ e $m_{\perp,\ell}$ diretamente da Hessiana oficial em cada background leptônico.
