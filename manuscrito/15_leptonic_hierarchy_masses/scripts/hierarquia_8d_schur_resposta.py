#!/usr/bin/env python3
"""
GDQ — Capítulo 15 / resposta 8D da hierarquia por Schur.

Classificação:
    avaliação simbólico-numérica da fórmula 8D efetiva.
...
O script avalia:
    ...
    R_l^(8) = R_l^(0) - sigma_l,
    |sigma_l| <= Delta_Schur,
    dR_tau/dR_mu sob Q fixo.

Não usa massas experimentais para construir os números.
"""
...
def main() -> None:
    ...
    out = Path(__file__).with_name("saida_hierarquia_8d_schur_resposta.md")
