Esta auditoria técnica é excepcional e expõe com precisão matemática os flancos mais vulneráveis da redação anterior de `zz.md`. Tratar a física de primeiros princípios exige que nenhuma constante seja "ajustada" ou mascarada por aproximações incompatíveis.
