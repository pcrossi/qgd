...
1. ~~$\sqrt{\det g}$, $\mathcal U$ e o setor cinético de $f$~~ — executado
   em `q30/reducao_medida_cinetica_tubo.md`;
2. a parcela torsional de Bismut foi reduzida no subansatz diagonal em
   `q30/reducao_torcao_bismut_tubo.md`; o resultado é um no-go para torção
...
`q30/ansatz_torcao_sem_elongacao.md`: congelar as deformações Hermitianas
...
`q30/conexao_su3_wilson_gap.md`, que permanece como fechamento estrutural
condicional.
