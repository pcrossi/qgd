...
Este documento aplica `ponte_global_local_lemas_sem_colar.md` e
`ponte_global_local_fechamento_c3.md` às Questões 37, 39 e 40, respeitando a
separação do Lema 6:
...
`teorema_heranca_normalizacao_eletromagnetica.md` demonstrou a implicação
correta:
