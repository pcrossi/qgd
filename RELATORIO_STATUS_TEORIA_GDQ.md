...
> `RELATORIO_STATUS_TEORIA_GDQ_REVISADO.md`.
>
...
1. os arquivos `questão_2.md` a `questão_41.md` (incluindo variantes:
   `questão_28_final.md`, `questão_29_final.md`, `questão_30_yang_mills.md`,
   `questão_40_faltas.md`, `questão_40_obs.md`);
2. os capítulos principais em `pt-br/` (manuscrito original), usados como
   referência cruzada, não como fonte primária de veredito.

Não foram usados `en/`, `bkp`, `lixo`, scripts de `37p/`, nem os documentos
de auditoria antigos (`respostas*.md`, `RELATORIO_AUDITORIA_COMPLETA_GDQ.md`
...
- **Q37** (derivação de \(\alpha\)) conclui que a fórmula fechada antiga
  ...
  nesta sessão: os scripts protótipo em `37p/` produziram valores de
...
2. **Duplicidade de arquivos sem reconciliação explícita** — pares como
   `questão_28.md`/`questão_28_final.md`, `questão_29.md`/`questão_29_final.md`,
   `questão_30.md`/`questão_30_yang_mills.md`, e o trio
   `questão_40.md`/`questão_40_faltas.md`/`questão_40_obs.md` coexistem sem
