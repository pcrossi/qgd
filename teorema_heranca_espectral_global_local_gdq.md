...
> `ponte_global_local_lemas_sem_colar.md`. DtN refere-se somente ao estômato.
...
1. [memory.md](memory.md): ação, bulk oficial, espaço espectral e status da
   ponte global–local.
2. [questão_39.md](questão_39.md): espectro global e hierarquia de massas.
3. [questão_40.md](questão_40.md): backgrounds bariônicos e observáveis.
4. [RELATORIO_TORCAO_SPIN_S3_R4T4.md](RELATORIO_TORCAO_SPIN_S3_R4T4.md):
   distinção e compatibilidade dos setores de torção.
5. [q28/indice_global_t5_s3.md](q28/indice_global_t5_s3.md): índice global.
6. [q28/resultado_indice_global_t5_s3.md](q28/resultado_indice_global_t5_s3.md):
   avaliação correspondente.
7. [q29/warp_oficial_t5_s3.py](q29/warp_oficial_t5_s3.py): cálculo do
   background global usado em Q29.
8. [corrente_simpletica_hessiana_gdq.md](corrente_simpletica_hessiana_gdq.md):
   normalização local e corrente da Hessiana.
9. [projecao_quarta_variacao_fluxo_conservado.md](projecao_quarta_variacao_fluxo_conservado.md):
   projeção física com torção conservada.
10. [q30/principio_sem_distanciamento_dois_estomatos.md](q30/principio_sem_distanciamento_dois_estomatos.md):
    distinção entre modo interno e separação mantida por fonte externa.
11. [nucleacao_par_mesonico_torcional.md](nucleacao_par_mesonico_torcional.md):
    exemplo em que Robin e perturbação podem ativar um setor local sem
    redefinir sua topologia global.
12. [teoria_interface_classico_quantica_gdq.md](teoria_interface_classico_quantica_gdq.md):
    cadeia fonte–Hessiana–resposta–registro.
13. [questão_34.md](questão_34.md) e os relatórios em [q34](q34): construção
    local dos kernels, loops e identidades do setor $U(1)$.
14. [questão_35.md](questão_35.md) e os relatórios em [q35](q35): escala
