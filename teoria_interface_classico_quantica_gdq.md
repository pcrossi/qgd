...
`derivacao_fonte_classica_interface_sg.md`. O acoplamento fundamental foi
...
`modelo_aparelho_minimo_gdq.md`. Os coeficientes do potencial do ponteiro, do
...
A Rota A foi concluída em `teorema_captura_born_interface_gdq.md`. A equação
...
A primeira Rota B foi construída em `detector_ohmico_gdq.md`. Um canal
