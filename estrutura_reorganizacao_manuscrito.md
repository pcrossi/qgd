...
- `questão_2.md`, `questão_3.md`, ...
- `faltas.md`;
- `possibilidades.md`;
- adendos em `q39/`, `q40/`, etc.
...
Incorporar questão 39 e pasta `q39/`.
...
- `q40/adendo_volume_superficie.md`;
- `q40/adendo_bulk_6pi5.md`;
- `q40/adendo_reducao_variacional_bulk.md`;
- `q40/adendo_ansatz_gp_fp.md`;
- `q40/adendo_cola_torcao_superficie.md`;
- `q40/adendo_neutron_deltaB.md`.
